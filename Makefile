...
PROJECT_BINARY_NAME=krampushack2018
...
bin/programs/%: programs/%.cpp $(OBJECTS)
	...
	@g++ -std=gnu++11 -Wall -Wuninitialized -Weffc++ $(OBJECTS) $< -o $@ -I./include -L$(ALLEGRO_LIB_DIR) $(ALLEGRO_LIBS_LINK_MAIN_ARGS) -lcurl $(OPENGL_LIB)
